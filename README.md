...
**Lưu ý:** Đây là dự án Bài tập lớn môn Lập trình Python do **Nhóm 9 TT02B** phát triển. Mọi tính năng nghiệp vụ cơ bản của một hệ thống POS (Point of Sale) đều được triển khai đầy đủ.
...
```
SuperMarket/
├── data/                    # Chứa file mẫu import và hình ảnh của sản phẩm
